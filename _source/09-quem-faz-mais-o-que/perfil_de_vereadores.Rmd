...
```{r, fig.height=3, fig.width=10, echo=FALSE, warning=FALSE, message=FALSE}
atos.legis.relativo = atos.tema.legislativo[3:nrow(atos.tema.legislativo), 2:11]/rowSums(atos.tema.legislativo[3:nrow(atos.tema.legislativo), 2:11])

atos.legis.relativo = cbind(Vereador = atos.tema.legislativo$Vereador[3:nrow(atos.tema.legislativo)], atos.legis.relativo)
...
radarchart( atos.legis.relativo[c(1,2,i), -1]  ,  cglcol = "grey80",  title =  atos.legis.relativo$Vereador[i],  pcol=rgb(0.8,0.2,0.5,0.9) , pfcol=rgb(0.8,0.2,0.5,0.4) , plwd=2, vlcex=0.8 )
  }
