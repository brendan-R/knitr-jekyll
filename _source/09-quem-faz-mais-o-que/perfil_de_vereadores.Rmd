...
Durante os 4 anos em que estiveram no cargo, os vereadores puderam enviar propostas para aprovação que são classificadas em diferentes categorias dependendo de sua objetivo. Existe um total de 10 categorias e abaixo estaremos traçando o perfil de cada vereador baseada nas propostas aprovadas pelo mesmo.
...
* Vereadores com registro de atividades consideradas medianas acumularam um total de propostas com valores **inferiores a 35**.

* 3 vereadores tiveram 100% ou quase 100% de todas suas propostas aprovadas em apenas uma categoria: **Alcindor Villarim** (Saúde), **Lourdes Costa** (Administração) e **Rodolfo Rodrigues** (Administração).
